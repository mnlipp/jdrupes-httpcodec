...
public class DefaultMultiValueConverter<T extends Iterable<V>, V>
    ...
    public DefaultMultiValueConverter(
        ...
        this(containerSupplier, (left, right) -> {
            ((Collection<V>) left).add(right);
        },
            itemConverter, ",", false);
    }
    ...
    @Override
    public Converter<V> valueConverter(T value) {
        return valueConverter;
    }
     ...
     * 
     * @see
     * org.jdrupes.httpcodec.protocols.http.fields.Converter#asFieldValue(java.
     * lang.Object)
     */
    @Override
